...
function align_clouds(tlsLasFile, lioPcdFile, g_LIO, outdir, lockTls)
...
fprintf('If the yaw alignment does not look good, you may add or subtract pi/2 from the yaw diff angle.\n');
