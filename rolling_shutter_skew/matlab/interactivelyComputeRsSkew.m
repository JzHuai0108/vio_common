function interactivelyComputeRsSkew(t_led, led_gap_px, homography)
...
% t_led the duration of a LED light in millisec.
...
drawLineEvents(0, 0);
    ...
    function drawLineEvents(src, evt)
        ...
        str = sprintf(['left x %.1f, right x %.1f\n', ...
            ...
            't-led %.4f ms, line delay %.6f ms\n', ...
            'homography corrected line delay %.6f ms\n'], ...
