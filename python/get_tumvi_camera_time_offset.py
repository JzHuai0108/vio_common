...
def main():
    ...
    for topic in topic_list:
        assert (abs(headerstamps_all[rawbag][topic] - times_all[rawbag][topic])>1e5).all()
        assert (abs(headerstamps_all[calibratedbag][topic] - times_all[calibratedbag][topic])<1e5).all()
    ...
    for topic in topic_list:
        #print(headerstamps_all[calibratedbag][topic] - headerstamps_all[rawbag][topic])
        diff = headerstamps_all[calibratedbag][topic] - headerstamps_all[rawbag][topic]
        assert (diff[1:] == diff[0]).all()

    deltac0 = headerstamps_all[calibratedbag]['/cam0/image_raw'][0] - headerstamps_all[rawbag]['/cam0/image_raw'][0]
    deltac1 = headerstamps_all[calibratedbag]['/cam1/image_raw'][0] - headerstamps_all[rawbag]['/cam1/image_raw'][0]
    overall_time_shift = headerstamps_all[calibratedbag]['/imu0'][0] - headerstamps_all[rawbag]['/imu0'][0]
